\chapter{Les opérateurs de la construction}
	...
	\section{Les Locateurs d'Ouvrage}
		...
		\subsection{L'architecte}
			...
			Elle dispose d'un monopole sur le projet architectural dès que la superficie construite est supérieure à \surface{150}  (\articleCu{L}{431-3})). Un arrêt du \CE{} donne qualité à l'Ordre pour attaquer un \PC{} qui ne respecterait pas cette disposition.
		...
		\subsection{Le contrôleur technique}
			...
			Elle a été réglementée en 1978 par la loi \nom{Spinetta}. Elle est réglementée par les articles \articleCodifie{L}{111-23} à \articleCch{L}{111-26}.
			...
			\subsubsection{La convention de contrôle}
				...
				\paragraph{Le recours au contrôle}
					...
					\subparagraph{Le recours obligatoire} est prévu par l'\articleCch{R}{111-38}, et notamment pour :
					\begin{itemize}
						\item les \emph{Établissement Recevant du Public} (\ERP), en application de l'\articleCch{R}{123-2} ;
						\item les \emph{Immeubles de Grande Hauteur} (\IGH), conformément à l'\articleCch{R}{122-2} ;
			...
			\subsubsection{La responsabilité du contrôleur technique}
				...
				\paragraph{À l'égard du maître d'ouvrage}
					...
					L'\articleCch{L}{111-24}\  pose une présomption de responsabilité dans les limites de sa mission.
